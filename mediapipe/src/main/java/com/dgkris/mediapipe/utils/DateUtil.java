...
public final class DateUtil {
    ...
    private static final Map<String, String> DATE_FORMAT_REGEXPS = new HashMap<String, String>() {{
        put("^[A-Za-z]{3}\\s[a-zA-Z]{3}\\s\\d{2}\\s\\d{1,2}:\\d{2}:\\d{2}\\s[a-zA-Z]{3}\\s\\d{4}$", "EEE MMM dd HH:mm:ss zzz yyyy");
        put("^[A-Za-z]{3},\\s\\d{1,2}\\s[A-Za-z]{3}\\s\\d{4}\\s\\d{1,2}:\\d{2}:\\d{2}\\s[\\+|\\-][0-9]{4}$", "EEE, dd MMM yyyy HH:mm:ss Z");
        put("^[A-Za-z]{3},\\s\\d{1,2}\\s[A-Za-z]{3}\\s\\d{4}\\s\\d{1,2}:\\d{2}:\\d{2}\\s[A-Za-z]{3}$", "EEE, dd MMM yyyy HH:mm:ss zzz");
        put("^\\d{8}$", "yyyyMMdd");
    ...
    public static String convertToStringWithDefaultFormat(DateTime dateTime) {
    ...
    public static void main(String args[]) throws Exception {
        ...
        System.out.println(simpleDateFormat.format(parse("Wed, 4 Jun 2014 00:53:49 +0530")));
        System.out.println(simpleDateFormat.format(parse("Sun, 22 Jun 2014 09:11:19 GMT")));
